...
<main id="main">
  ...
  <div style="position: relative;">
            ...
            style="margin-top: -24px; border:solid gray 2px; width: 30%; max-height:400px">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="footer-info">
                        ...
                        <p>
                            Tom Mboya Street <br>
                            90420, Mombasa<br><br>
                            <strong>Phone:</strong>+254 719 885 775<br>+254 721918078<br>
        ...
        <div class="container">
            ...
            <section class="widget widget_rtc_social_links">
                    <ul class="social-networks">
                        <li>
                            <a href="https://www.facebook.com/GKaDElectronicsCompany/" target="_blank" rel="nofollow noopener">
                        ...
                        <li>
                            <a href="https://www.linkedin.com/in/gkad-electronics-solution-300452252" target="_blank" rel="nofollow noopener">
